...
`binconf()` is licensed under GPL (>=2) by Frank Harrell's [`Hmisc`](https://github.com/harrelfe/Hmisc) package.

`Gmean()`, `MeanCI()`, `MedianCI()`,`SignTest()`, and `Winsorize()` are licensed under GPL (>= 2) by Andri Signorell's [DescTools](https://cran.r-project.org/package=DescTools) package.
